...
$szBaseURL = sprintf("%s?vPartName=%s", $_SERVER['PHP_SELF'],
$szPartName);

$szPageParam = sprintf("vPartName=%s", $szPartName);

$szFPConceptVideosFN = sprintf("%s/%s.txt", $szRootAnnDir, $szPartName);
...
printf("<P><H1> Videos in part [ %s ] </H1></P>\n", $szPartName );
...
$szKFVideosDir = sprintf("%s/%s", $szRootKfDir, $szPartName);
